...
\restrict bLGXkXHN8B15lAaGXjKhvhGNa8ReDWXXHEb0jzjDpo9caoBxdKrzDge0wOlnUFR
...
1	2026-06-23	feijao com farinha	feija com farinha
2	2026-06-24	estrogonoff	batata palha,arroz,frango
3	2026-04-25	hamburguer	salada,carne,pao,molho
...
--
-- Name: idx_restricao; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_restricao ON public.item_restricao USING btree (id_restricao);
...
\unrestrict bLGXkXHN8B15lAaGXjKhvhGNa8ReDWXXHEb0jzjDpo9caoBxdKrzDge0wOlnUFR
